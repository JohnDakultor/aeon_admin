    ...
    <div className="flex h-screen bg-gray-100">
      ...
      >
        ...
        <ul>
          ...
          <li className="mb-4">
            <a href="/admin/bookings" className="hover:text-blue-300">Manage Bookings</a>
          </li>
          <li className="mb-4">
            <a href="/admin/rooms" className="hover:text-blue-300">Manage Rooms</a>
          </li>
        </ul>
      </div>
      ...
      <div className="flex-1 md:ml-64 p-4 md:p-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold">Sales Breakdown (Past Months)</h2>
            <div className="mt-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="mt-4 w-full max-w-xs mx-auto">
              <Pie data={roomsData} options={{ responsive: true, maintainAspectRatio: true }} />
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="mt-4 w-full max-w-xs mx-auto">
              <Pie data={salesThisMonthData} options={{ responsive: true, maintainAspectRatio: true }} />
            </div>
          </div>
        </div>
      </div>
